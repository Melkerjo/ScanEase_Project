            ...
            modelBuilder.Entity("SCANEASE_API.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 40,
                            Date = new DateTime(2024, 5, 12, 22, 52, 9, 24, DateTimeKind.Local).AddTicks(8558),
                            Quantity = 3,
                            UserId = 4
                        },
                        new
                        {
                            Id = 2,
                            Amount = 115,
                            Date = new DateTime(2024, 5, 11, 22, 52, 9, 24, DateTimeKind.Local).AddTicks(8566),
                            Quantity = 5,
                            UserId = 4
                        });
                });
            ...
            modelBuilder.Entity("SCANEASE_API.Models.OrderProduct", b =>
                {
                    ...
                    b.HasOne("SCANEASE_API.Models.Product", "Product")
                        .WithMany()
